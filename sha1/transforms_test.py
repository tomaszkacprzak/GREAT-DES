...
def get_multiexp_object(transforms,truth):
    """
...
def main():
    ...
    parser.add_argument('-o', '--filename_output', default='wcs_test_card_01.meds',type=str, action='store', help='name of the output meds file')
    ...
    transforms = yaml.load(open(args.filename_config))['transforms_xy']
    truth = yaml.load(open(args.filename_config))['truth']

    get_multiexp_object(transforms,truth)
